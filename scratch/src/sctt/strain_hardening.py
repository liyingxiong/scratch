...
#         i = 1
        for load in self.load_steps[0]:
            ...
            if len(self.crack_arr) == 0:
                strain_arr = np.append(strain_arr, load / 10.)
            else:
...
#     m_stress.plot(test.matrix_strength.xgrid, test.matrix_strength.random_field, \
#              color='black', label='Strength Field')
#     m_stress.plot(test.matrix_strength.xgrid, mat_sta[0], \
#              color='blue', label='Stress Field')
